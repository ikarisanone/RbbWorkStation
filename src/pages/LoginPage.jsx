...
const LoginPage = () => {
  ...
  const demoAccounts = [
    { email: 'superadmin@example.com', password: 'password123', role: 'Süper Admin' },
    { email: 'yonetici@example.com', password: 'password123', role: 'Yönetici' },
    { email: 'uye1@example.com', password: 'password123', role: 'Ekip Üyesi' },
    { email: 'misafir@example.com', password: 'password123', role: 'Misafir' }
  ];
